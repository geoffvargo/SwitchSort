package com.geoffvargo.CoderByte.SwitchSort;

import java.util.*;
/**
 * Switch Sort
 * Have the function {@code SwitchSort(arr)} take arr which will be an array consisting of integers 1...size(arr) and
...
class Main {
	...
	public static void main(String[] args) {
		...
		System.out.print(SwitchSort(Arrays.stream(s1.split("\\D+")).mapToInt(Integer::parseInt).toArray()));
	}
